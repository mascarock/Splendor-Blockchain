...
use splendor_chain_runtime::{self, opaque::Block, RuntimeApi};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        splendor_chain_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        splendor_chain_runtime::native_version()
    }
}
...
pub fn frontier_database_dir(config: &Configuration) -> std::path::PathBuf {
	let config_dir = config
		...
		.unwrap_or_else(|| {
			BasePath::from_project("", "", "splendor-pow")
...
pub fn build_pow_import_queue(
    ...
    let pow_block_import = sc_consensus_pow::PowBlockImport::new(
        ...
        move |_, ()| async move {
            ...
            let author =
                splendor_chain_runtime::block_author::InherentDataProvider(Default::default());
        ...
        if instant_seal {
            ...
            let (mining_worker, mining_worker_task) = sc_consensus_pow::start_mining_worker(
                ...
                move |_, ()| async move {
                    ...
                    let author = splendor_chain_runtime::block_author::InherentDataProvider(
